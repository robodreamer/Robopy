# -*- coding: utf-8 -*-
"""
09-13-2013 Construct a Hubo II+ model
Written by Andy Park (Purdue University) on 07-23-13 (original file)
"""
...
class construct_Huboplus:
    ...
    body_com[K-1,] = [-0.012258116293, -0.002473149928, -0.048635606065]
    body_mass[K-1] = 7.503338799400
    body_I[K-1,] = [0.102019217897, 0.083272393713, 0.086493014809, 0.000024546177, -0.001317325511, 0.007130222433] #Inertia Ixx Iyy Izz Ixy Iyz Izx
    body_parent[K-1] = -1
    ...
    body_com[K-1,] = [-0.013850358943, 0.000007806523, -0.035461283862]
    body_mass[K-1] = 3.417193968804
    body_I[K-1,] = [0.018034853826, 0.009123817212, 0.022051361197, 0.000031753060, -0.000069061669, -0.000513489041] #Inertia Ixx Iyy Izz Ixy Iyz Izx
    ...
    body_com[K-1,] = [0.034706500276, 0.000037480007, -0.072615273181]   
    body_mass[K-1] = 0.826125012988
    body_I[K-1,] = [0.001518175906, 0.002863333718, 0.002114373967, 0.000002135861, -0.000000157525, 0.000434128327] #Inertia Ixx Iyy Izz Ixy Iyz Izx
    ...
    body_com[K-1,] = [-0.049747912596, 0.012531116599, -0.015643664572]
    body_mass[K-1] = 1.932656684780
    body_I[K-1,] = [0.004034872008, 0.003327066518, 0.003171733387, 0.000079452031, -0.000551964047, -0.000125342881] #Inertia Ixx Iyy Izz Ixy Iyz Izx
    ...
    body_com[K-1,] = [0.019504891350, -0.059577480789, -0.175201757627]
    body_mass[K-1] = 2.820095294731
    body_I[K-1,] = [0.029510226255, 0.027377052037, 0.008380352842, 0.000184398776, 0.000656580164, -0.000370291227] #Inertia Ixx Iyy Izz Ixy Iyz Izx
    ...
    body_com[K-1,] = [0.012825433376, -0.007275670525, -0.171431348038]
    body_mass[K-1] = 1.809116607048
    body_I[K-1,] = [0.023215644043, 0.020834230825, 0.005920398408, 0.000251648144, 0.002780676346, -0.001293430587] #Inertia Ixx Iyy Izz Ixy Iyz Izx
    ...
    body_com[K-1,] = [0.019870246084, -0.045969255056, 0.011506941050]
    body_mass[K-1] = 1.635010626057
    body_I[K-1,] = [0.002316586138, 0.003304106079, 0.002794946081, 0.000018740179, 0.000063815303, 0.000369899000] #Inertia Ixx Iyy Izz Ixy Iyz Izx
    ...
    body_com[K-1,] = [-0.051509407797, 0.002163982128, -0.069388069491]
    body_mass[K-1] = 1.20318
    body_I[K-1,] = [0.002951826559, 0.005247924231, 0.005168173927, 0.000032321137, 0.000059540355, 0.000141769152] #Inertia Ixx Iyy Izz Ixy Iyz Izx
    ...
    body_com[K-1,] = [0.016720721524, 0.057040679167, 0.000009918731]
    body_mass[K-1] = 0.646654803406
    body_I[K-1,] = [0.000893730666, 0.000930159822, 0.001243225119, -0.000156483989, 0.000000157095, 0.000000498007] #Inertia Ixx Iyy Izz Ixy Iyz Izx
    body_parent[K-1] = body_name.index('Body Torso')
    body_no_child_frames[K-1] = 1
    ...
    body_com[K-1,] = [-0.036207973807, -0.000083124345, -0.001266848323]
    body_mass[K-1] = 0.413367772877
    body_I[K-1,] = [0.000269283340, 0.000376789510, 0.000360354691, 0.000000452571, 0.000000993935, 0.000003236618] #Inertia Ixx Iyy Izz Ixy Iyz Izx
    ...
    body_com[K-1,] = [0.004561211264, 0.000031057603, -0.090782377537]
    body_mass[K-1] = 1.154608561577
    body_I[K-1,] = [0.003654788538, 0.003647313707, 0.000606330376, 0.000002054362, -0.000030964786, 0.000418448220] #Inertia Ixx Iyy Izz Ixy Iyz Izx
    ...
    body_com[K-1,] = [-0.021734910228, 0.017831394355, -0.061087268246]
    body_mass[K-1] = 0.440940029986
    body_I[K-1,] = [0.000502700471, 0.000494150112, 0.000131786442, 0.000003645865, 0.000007655278, -0.000014138784] #Inertia Ixx Iyy Izz Ixy Iyz Izx
    ...
    body_com[K-1,] = [-0.001220192079, 0.000635233335, -0.023804318643]
    body_mass[K-1] = 0.537738149550
    body_I[K-1,] = [0.000634569731, 0.000563917510, 0.000305422235, -0.000000462486, 0.000035404433, 0.000006206816] #Inertia Ixx Iyy Izz Ixy Iyz Izx
    ...
    body_com[K-1,] = [-0.000258199377, 0.011441986656, -0.046147242821]
    body_mass[K-1] = 0.164392998329
    body_I[K-1,] = [0.000097432742, 0.000144494281, 0.000122681345, -0.000000522155, 0.000009492703, -0.000001173170] #Inertia Ixx Iyy Izz Ixy Iyz Izx
...
#    body_child_frame[K-1,:1] = [Frame_LH]
    ...
    body_com[K-1,] = [-0.000258199377, -0.011441986656, -0.046147242821]
    body_mass[K-1] = 0.164392998329
    body_I[K-1,] = [0.000097432742, 0.000144494281, 0.000122681345, 0.000000522155, -0.000009492703, -0.000009492703] #Inertia Ixx Iyy Izz Ixy Iyz Izx
...
#    body_child_frame[K-1,:1] = [Frame_RH]
    ...
    joint_translation[K-1,] = [0.0122662, 0.00245974, -0.15262]
    ...
    joint_axis[K-1,] = [0, 0, 1]
    joint_translation[K-1,] = [0.000125136, 0.0885155, -0.0764689]
    joint_rotation[K-1,] = [0, 0, 0]
    ...
    joint_translation[K-1,] = [0.0520001, 1.50498e-06, -0.091004]
    joint_rotation[K-1,] = [0, 0, 0]
    ...
    joint_translation[K-1,] = [-0.0529074, 0.0655748, 9.99159e-05]
    joint_rotation[K-1,] = [0, 0, 0]
    ...
    joint_axis[K-1,] = [0, 1, 0]
    joint_translation[K-1,] = [0.000766364, -0.0445011, -0.280007]
    joint_rotation[K-1,] = [0, 0, 0]
    joint_q_min[K-1] = -0.174
    ...
    joint_axis[K-1,] = [0, 1, 0]
    joint_translation[K-1,] = [7.20248e-06, 0.0247555, -0.279942]
    joint_rotation[K-1,] = [0, 0, 0]
    joint_q_min[K-1] = -1.5708
    joint_q_max[K-1] = 1.5708
    ...
    joint_axis[K-1,] = [1, 0, 0]
    joint_translation[K-1,] = [0.0, -0.0466006, -1.04e-10]
    joint_rotation[K-1,] = [0, 0, 0]
    joint_q_min[K-1] = -1.5708
    joint_q_max[K-1] = 1.5708
    ...
    joint_axis[K-1,] = [0, 0, 1]
    joint_translation[K-1,] = [0.000125136, -0.0884999, -0.0764689]
    joint_rotation[K-1,] = [0, 0, 0]
    joint_q_min[K-1] = -1.7453
    joint_q_max[K-1] = 1.7453
    ...
    joint_axis[K-1,] = [1, 0, 0]
    joint_translation[K-1,] = [0.0520001, 7.3455e-05, -0.091004]
    joint_rotation[K-1,] = [0, 0, 0]
    ...
    joint_axis[K-1,] = [0, 1, 0]
    joint_translation[K-1,] = [0.0122581, 0.143973, 0.0486356]
    joint_rotation[K-1,] = [0, 0, 0]
    ...
    joint_axis[K-1,] = [1, 0, 0]
    joint_translation[K-1,] = [0.0269, 0.072, 0]
    joint_rotation[K-1,] = [0, 0, 0]
    ...
    joint_axis[K-1,] = [0, 0, 1]
    joint_translation[K-1,] = [-0.0269, -0.000166249, -0.0245]
    joint_rotation[K-1,] = [0, 0, 0]
    joint_q_min[K-1] = -3.1415
    joint_q_max[K-1] = 3.1415
    ...
    joint_axis[K-1,] = [0, 1, 0]
    joint_translation[K-1,] = [0.0219936, -0.018, -0.157505]
    joint_rotation[K-1,] = [0, 0, 0]
    ...
    joint_axis[K-1,] = [0, 0, 1]
    joint_translation[K-1,] = [-0.0219906, 0.018, -0.111408]
    joint_rotation[K-1,] = [0, 0, 0]
    joint_q_min[K-1] = -3.1415
    joint_q_max[K-1] = 3.1415
    ...
    joint_axis[K-1,] = [0, 1, 0]
    joint_translation[K-1,] = [1.72973e-06, -0.00872953, -0.05255]
    joint_rotation[K-1,] = [0, 0, 0]
    joint_q_min[K-1] = -3.1415
    joint_q_max[K-1] = 3.1415
...
#    joint_q_max[K-1] = 3.1415
    ...
    joint_axis[K-1,] = [0, 1, 0]
    joint_translation[K-1,] = [0.0122581, -0.139027, 0.0486356]
    joint_rotation[K-1,] = [0, 0, 0]
    joint_q_min[K-1] = -3.1415
    joint_q_max[K-1] = 3.1415
    ...
    joint_axis[K-1,] = [0, 0, 1]
    joint_translation[K-1,] = [-0.0269, 0, -0.0245]
    joint_rotation[K-1,] = [0, 0, 0]
    joint_q_min[K-1] = -3.1415
    joint_q_max[K-1] = 3.1415
    ...
    joint_axis[K-1,] = [0, 1, 0]
    joint_translation[K-1,] = [1.72973e-06, 0.01, -0.05255]
    joint_rotation[K-1,] = [0, 0, 0]
    joint_q_min[K-1] = -3.1415
    joint_q_max[K-1] = 3.1415
...
#    joint_q_max[K-1] = 3.1415
    ...
    frame_axis[K-1] = -1
    frame_translation[K-1,] = [0, 0, -0.001 * 94.48]
    ...
    frame_axis[K-1] = -1
    frame_translation[K-1,] = [0, 0, -0.001 * 122.2]
    frame_rotation[K-1,] = [0, 0, 0]
